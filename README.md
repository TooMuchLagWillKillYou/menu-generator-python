...
The menu can be exported in different formats containing different items. Not all formats contain all the items.
The menu can be translated into one or multiple of the below-mentioned languages.
...
without changing the order for any reason.
The system should understand when the current page is full and it's time to create another one.

All this work was done manually every time a price or an item was added or edited. That's why this project was born.
...
Formats: [
    {
        ...
        'description':  "The most important format; it is given to the restaurant's guests at the beginning of the serving"
    },
    {
        'name':         'dessert',
        'size':         '148x210mm',
        'categories':   [ 8, 9, 10, 11, 12 ],
        'description':  "It is given to the restaurant's customers after they have eaten the main serving"
    },
    {
        'name':         'instagram',
        'size':         '1080x1350px',
